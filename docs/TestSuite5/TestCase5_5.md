...
17. Verify that he can view the BIEc, but the fields of BIE’s nodes are not editable. (Assertion [#6](#test-assertion-6))
...
46. Verify that the Version, Status, Business Term, Remark and Context Definition fields of the root BIE node are editable. (Assertion [#17](#test-assertion-17).1)
47. Verify that the Min, Max, Nillable, Business Term, Remark and Context Definition fields of the ASBIE node are editable and that the Association Definition, Component Definition and Type Definition fields are not. (Assertion [#17](#test-assertion-17).2)
48. Verify that the Min, Max, Nillable, Fixed Value, Business Term, Remark, Primitive Restriction and Context Definition fields of the BBIE node are editable and that the Association and Component Definition fields are not. (Assertion [#17](#test-assertion-17).3)
49. Verify that the Min, Max, Nillable, Fixed Value, Business Term, Remark, Primitive Restriction and Context Definition fields of the SC node are editable, and the Association and Component Definition fields are not. (Assertion [#17](#test-assertion-17).3)
...
56. Verify that the field is successfully updated. (Assertion [#18](#test-assertion-18))
...
60. Verify that an error is returned and that the Update button is disabled (Assertion [#18](#test-assertion-18).1)
61. He enables some nodes with original Min Cardinality 0, he changes it to 1 and Updates the BIE.
62. Verify that the BIE is successfully updated with the new content. (Assertion [#18](#test-assertion-18).1 [#18](#test-assertion-18).2)
...
64. Verify that the BIE is successfully updated with the new content. (Assertion [#18](#test-assertion-18).2)
65. He sets the above Min Cardinality to -1.
66. Verify that the application indicates an error and that the Update button is disabled. (Assertion [#18](#test-assertion-18).2)
...
68. Verify that the application gives a warning message that the Context Definition field is blank. (Assertion [#18](#test-assertion-18).3)
...
70. Verify that the application indicates an error and that the Update button is disabled (Assertion [#18](#test-assertion-18).4)
71. Then he sets the Max Cardinality to 0.
72. Verify that the application indicates an error and that the Update button is disabled. (Assertion [#18](#test-assertion-18).4)
73. Then he sets Min Cardinality to -1.
74. Verify that the application indicates an error and that the Update button is disabled. (Assertion [#18](#test-assertion-18).5)
75. Then He sets Min Cardinality to -5.
76. Verify that the application indicates an error and that the Update button is disabled. (Assertion [#18](#test-assertion-18).5)
...
78. Verify that the BIE is successfully updated with the new content. (Assertion [#18](#test-assertion-18).6)
79. He sets the Min Cardinality of a node (e.g. Release Identifier) to a higher value than the value of Max Cardinality.
80. Verify that the application indicates an error and that the Update button is disabled. (Assertion [#18](#test-assertion-18).7)
81. He sets the Max Cardinality of different nodes to -1.
82. Verify that the BIE is updated with the new content and that Max Cardinality field is set to “unbounded”. (Assertion [#18](#test-assertion-18).8)
83. He restores the previous values of the elements and he sets their Max Cardinality to “unbounded”.
84. Verify that the BIE is updated with the new content and that Max Cardinality field is set to “unbounded”. (Assertion [#18](#test-assertion-18).9)
...
89. Verify that the application reset the Primitive Type of the Creation Date Time node to “Primitive” and the Primitive is reset back to “Token”. (Assertion [#19](#test-assertion-19).1)
90. The developer sets its Primitive Type to “Agency”.
91. He clicks Update.
92. Verify that the application reset the Primitive Type of the Creation Date Time node to “Primitive” and the Primitive is reset back to “Token”. (Assertion [#19](#test-assertion-19).1)
93. Verify that “string” and “integer” are not included in the Primitive drop down list. (Partially covering Assertion [#19](#test-assertion-19).2)
...
99. Verify that only oacl_LanguageCode, clm56392A20081107_LanguageCode, and oacl_ LanguageCodeExtension are present in the dropdown list. (Assertion [#19](#test-assertion-19).3, [#20](#test-assertion-20))
...
172. Verify that at least the BIE “Show Credit” is returned. (Assertion [#30](#test-assertion-30))
