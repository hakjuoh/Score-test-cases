...
1. The developer can create a code list without base with only required information. See Create a Brand New Code List in Score User Guide for Mandatory/Optional fields. In addition, Code list value cannot be duplicated.
2. The developer can create a code list without base with all information specified and multiple code values.
3. The developer can remove a code value during the code list without base creation.
4. The developer cannot create a code list without base with missing required information including missing required information in the code value table.
5. The developer cannot create a code list without base, when it does not meet a uniqueness constraint. See Create a Brand New Code List in Score User Guide for the uniqueness constraint.
6. The developer can see, in the code list page, all code lists created by any user.
7. The developer has access to edit an unpublished code list created by any user.
8. The developer can view the detail of a published code list created by any user.
9. The developer cannot update a published code list created by any user.
10. The developer can update a code list without base, which has only required information including adding and removing code values.
11. The developer can update a code list without base that has all information specified including adding and removing code values.
12. The developer cannot update a code list without base that has missing required information including missing required information in the code value.
13. The developer can publish a previously saved code list without base, which has only required information.
14. The developer can publish a previously saved a code list without base with all information specified including those in code values.
15. The developer cannot publish a previously saved code list without base that has missing required information including missing required information in the code value.
16. Only published code lists without base can be used in BIE (and CC – we will not test for CC at this time as CC Editing function is not ready).
17. The developer cannot discard a code list once it has been published.
18. The developer can create a code list with base that has only required information. See Create a Brand New Code List in Score User Guide for Mandatory/Optional fields.
19. The developer can create a code list with base with all information specified and with some code value restrictions and extensions added. The developer cannot change any field of the inherited code value.
20. The developer can remove a code value during the code list with base creation.
21. The developer cannot create a code list with base with missing required information including missing required information in the code value table.
22. The developer cannot create a code list with base, when it does not meet a uniqueness constraint. See Create a Brand New Code List in Score User Guide for the uniqueness constraint.
23. The developer can update a code list with base that has only required information including adding, removing and restricting, unrestricting code values. The developer cannot change any field of the inherited code value.
24. The developer can update a code list with base that has all information specified including adding, removing, restricting, unrestricting code values. The developer cannot change any field of the inherited code value.
25. The developer cannot update a code list with base that has missing required information including missing required information in the code value.
26. The developer can publish a previously saved a code list with base.
27. The developer cannot publish a previously saved code list with base that has missing required information including missing required information in the code value.
28. Only published code lists with base can be used in BIE (and CC – we will not test for CC at this time as CC Editing function is not ready).
29. Restricted code value in the base code list is displayed but cannot be enabled.
30. The search feature is at least working.
31. Only extensible code list can be a base code list.
32. Unpublished code list cannot be used as a base.
33. A confirmation message should be returned when creating a Code List with the same name as another Code List.
34. A confirmation message should be returned when updating a Code List specifying a name which is the same with another Code List.
35. The developer can select a Code List from the Code List page, navigate thought different paginator pages while the forenamed Code List remains checked.
36. The developer can select a Code List Value from a Code List, navigate thought different paginator pages storing the code lists values while the forenamed Code List value remains checked.
...
3. Verify that both CL0 and CL1 are successfully recorded by the application and that he couldn’t add a duplicate value to CL0. (Assertion #1)
...
5. Verify that the code list is successfully recorded by the application. (Assertion #2, #3)
...
20. Verify that the application indicates an error and that the new code list is not recorded By verifying that the CL4 is not displayed in the “Code Lists” page. (Assertion #5)
21. The developer visits the Code List page.
22. Verify that he can see in the list CL0, CL1, CL2, CLa, CLb, CLx, and CLy. (Assertion #6)
23. The developer clicks to view CLa.
24. Verify that all fields are editable, and the Update button is present. (Assertion #7)
25. The developer goes back to the Code List page.
26. Clicks to view CLx.
27. Verify that all fields are editable, and the Update button is present. (Assertion #7)
28. The developer goes back to the Code List page.
29. Clicks to view CLb.
30. Verify that no field is editable and that the Update, Discard and Publish buttons are not displayed. (Assertion #8, #9)
31. The developer goes back to the Code List page.
32. Clicks to view CLy.
33. Verify that no field is editable, and the Update, Discard and Publish buttons are displayed. (Assertion #8, #9)
...
37. Verify that CL0 is successfully updated with the new content and that he cannot add a duplicate value (Assertion #7, #10)
...
40. Verify that CL2 is successfully updated with the new content. (Assertion #11)
41. The developer clicks to view CLx.
42. The developer deletes the content of the Name field and clicks Update.
43. Verify that the “Update” button is disabled. (Assertion #12)
...
45. Verify that the “Update” button is disabled. (Assertion #12)
...
47. Verify that the “Update” button is disabled. (Assertion #12)
...
49. Verify that the “Update” button is disabled. (Assertion #12)
...
51. Verify that the “Edit” button is disabled. (Assertion #12)
...
65. Verify that the “Publish” button is disabled. (Assertion #15)
...
67. Verify that the “Publish” button is disabled. (Assertion #15)
...
69. Verify that the “Publish” button is disabled. (Assertion #15)
...
71. Verify that the “Edit” button is disabled. (Assertion #15)
...
73. Verify that the “Edit” button is disabled. (Assertion #15)
...
77. Verify that the code List “Code List Test Editing” is not present in the list. (Assertion #16)
78. The developer goes to the Code List page.
79. Verify that the checkbox used to discard the CL0 is disabled. (Assertion #17)
80. Clicks to view CL0.
81. Verify that Discard button is absent. (Assertion #17)
...
86. Verify that the code list, say CL1_e0, is successfully recorded by the application. (Assertion #18)
...
91. Verify that the inherited code list values are not editable and so they cannot be changed (Assertion #19)
...
93. Verify that the CL2_e0 is successfully recorded by the application and that he could not add a duplicate value. (Assertion #19, #20)
94. The developer access the code list with base creation by clicking “Code List” and “Create Code List from another” menu.
95. The developer search for CL2 and choose it as a base. (Assertion #31)
96. The developer specifies all fields except the Name field and tries to click the “Create” button.
97. Verify that the “Create” button is disabled. (Assertion #21)
...
99. Verify that the “Create” button is disabled. (Assertion #21)
...
101. Verify that the “Create” button is disabled. (Assertion #21)
...
103. Verify that the “Create” button is disabled. (Assertion #21)
...
105. Verify that the “Add” button is disabled. (Assertion #21)
...
107. Verify that the “Add” button is disabled. (Assertion #21)
...
109. Verify that the application indicates an error and that the new code list is not recorded by verifying that it is not displayed in the “Code Lists” page. (Assertion #22)
110. The developer goes back to Code List page.
111. Clicks to view CL1_e0.
112. Verify that the code list values fields inherited from CL1 are not editable. (Assertion #23)
...
114. Verify that the code list is successfully updated with the new content. (Assertion #23)
115. The developer goes back to Code List page.
116. Clicks to view CL2_e0.
117. Verify that the code list values fields inherited from CL2 are not editable. (Assertion #24)
...
119. Verify that the code list is successfully updated with the new content. (Assertion #24)
...
123. Verify that the “Update” button is disabled. (Assertion #25)
...
125. Verify that the “Update” button is disabled. (Assertion #25)
...
127. Verify that “Update” button is disabled. (Assertion #25)
...
129. Verify that the “Update” button is disabled. (Assertion #25)
...
131. Verify that the “Add” button is disabled. (Assertion #25)
...
133. Verify that the “Add” button is disabled. (Assertion #25)
134. The developer goes back to Code List page.
135. Clicks to view CL1_e0.
136. The developer publishes the code list.
137. Verify that the code list is in Published state. (Assertion #26)
...
141. Verify that the “Publish” button is disabled. (Assertion #27)
...
143. Verify that the “Publish” button is disabled. (Assertion #27)
...
145. Verify that the “Publish” button is disabled. (Assertion #27)
...
147. Verify that the “Publish” button is disabled. (Assertion #27)
...
149. Verify that the “Add” button is disabled. (Assertion #27)
...
151. Verify that the “Add” button is disabled. (Assertion #27)
...
155. Verify that “Code List Test Editing” Code List is not present in the list and that the CL1_e0 is displayed. (Assertion #28)
...
159. Verify that the restricted code values of the CL2 are not displayed. (Assertion #29, #21)
...
164. Verify that at least the code list “Non Extensible Code List” is returned. (Assertion #30)
165. The developer selects “oagis” as Updater and clicks search button.
166. Verify that at least the code list “Non Extensible Code List” is returned. (Assertion #30)
167. The developer selects 1/1/2019 as Updated start date.
168. Verify that at least the code list “oacl_UnitCode” is returned. (Assertion #30)
...
171. Verify that the “US, FDA (Food and Drug Administration)” appears but not the “CCC (Customs Co-operation Council)”. (Assertion #30)
172. The developer clicks to view this code list.
173. Verify that the Create Code List based on this button is absent and so the code list cannot be extended. (Assertion #31)
174. Click on the menu Code List -> Create Code List based on Another. Enter in the search box “extensible”. (Assertion #30)
175. Verify that “Non Extensible Code List” does not show up for selection. (Assertion #31)
176. Ensure that CL2_e0e0 is extensible but unpublished.
177. The developer clicks to view CL2_e0e0.
178. Verify that the Create Code List based on this button is absent and so the code list cannot be extended. (Assertion #32)
179. Click on the menu Code List -> Create Code List based on Another. Use the Search box to find CL2_e0e0.
180. Verify that CL2_e1e1 does not show up for selection. (Assertion #32)
...
182. Verify that a confirmation message is returned (Assertion #33).
183. The developer confirms his intention.
184. Verify that the code list is recorded (Assertion #33)
...
186. Verify that a confirmation message is returned (Assertion #34)
187. The developer confirms his intention
188. Verify that the code list is updated (Assertion #34)
...
190. Verify that a confirmation message is returned (Assertion #33).
191. The developer confirms his intention.
192. Verify that the code list is recorded (Assertion #33)
...
194. Verify that a confirmation message is returned (Assertion #34) where the developer confirms his intention
195. Verify that the code list is updated (Assertion #34)
...
197. Verify that the checkbox of the selected Code List is checked. (Assertion #35)
...
199. Verify that the checkbox of the selected Code List value is checked. (Assertion #36)